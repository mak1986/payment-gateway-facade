...
describe('GatewayFacade', function(){
	...
	beforeEach(function(){
		...
		gatewayFacade.addConfig('gateway_names', [
			{ 
				"machine_name": "paypal", 
				"pretty_name": "PayPal",
	...
	describe('Public methods', function(){
		...
		describe('refreshGateways()', function(){
			...
			it('configured to use only 1 gateway', function(){			
				...
				gatewayFacade.addConfig('gateway_names', config);
				gatewayFacade.refreshGateways();
		...
		describe('Helper methods', function(){
			...
			it('getConfig(key) return the correct value', function(){
				var obj = {'key': 'value'};
				gatewayFacade.addConfig('test_key', obj);
				expect(gatewayFacade.getConfig('test_key')).to.deep.equal(obj);
			});
